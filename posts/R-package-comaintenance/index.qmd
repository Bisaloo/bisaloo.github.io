...
In these projects, hierarchies and processes are thus not as clearly defined as they might be in a company.
...
Another example is the [lightr R package](https://docs.ropensci.org/lightr) I'm maintaining, where we sometimes discuss proprietary documentation that was shared in confidence by spectrometer manufacturers.
